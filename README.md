...
4. Dentro de la terminal, clonar el repositorio [tp-cloud-bootcamp-devops-we](https://www.youtube.com/watch?v=S2YFqf4L7l8&t=160s). en el se encuentran el repositorio para la aplicacion lanzada y los scripts para ejecucion de configuracion.
